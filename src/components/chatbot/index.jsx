  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "bot",
      text: "Hello! I am the DPS Damanjodi AI School Assistant. How can I help you today? You can ask about admissions, exams, or academic calendars.",
      time: "Just now"
    }
  ]);
