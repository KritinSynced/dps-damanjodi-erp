...
import { CheckCircle2, AlertCircle, FileText, ClipboardList, Search, ArrowRight } from "lucide-react";
      ...
      <section className="bg-slate-950 py-16 text-center text-white relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 space-y-3">
          ...
          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">
            Secure your child&apos;s educational path. Apply online, download guides, and track progress.
          </p>
        </div>
      </section>
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="space-y-1">
                        <h4 className="font-bold text-sm">Registration Confirmation</h4>
                        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                          Once documents are validated and registration is approved, a student registration number and class block are assigned.
                        </p>
                      </div>
                    </div>
                  </div>
