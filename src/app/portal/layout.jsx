...
function DesktopSidebar({ menu, user, logout }) {
  return (
...
function DesktopSidebarWithParams({ menu, user, logout }) {
  const searchParams = useSearchParams();
  const currentTab = searchParams.get("tab") || "dashboard";
  return <DesktopSidebarInner menu={menu} user={user} logout={logout} currentTab={currentTab} />;
}

function DesktopSidebarInner({ menu, user, logout, currentTab }) {
  return (
...
function MobileHeader({ menu, user, logout }) {
  return (
...
function MobileHeaderWithParams({ menu, user, logout }) {
  const searchParams = useSearchParams();
  const currentTab = searchParams.get("tab") || "dashboard";
  return <MobileHeaderInner menu={menu} user={user} logout={logout} currentTab={currentTab} />;
}

function MobileHeaderInner({ menu, user, logout, currentTab }) {
