      ...
      <section className="py-12 bg-background text-sm text-muted-foreground leading-relaxed">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p>
              We collect information necessary for school administration, including student profiles (names, admission numbers, grades, attendance), parent contact details (telephone, emails, occupation), and billing transactions.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              Academic profiles, class attendance, and fee payments are utilized strictly to update portals, issue official report cards, print transport logs, and dispatch PTM schedules. We do not sell or lease student records to external marketing firms.
            </p>
          </div>
